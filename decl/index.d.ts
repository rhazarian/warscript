...
/** @noResolution */
declare module "warscript.ext.base64" {
    export interface Base64Encoder {
        __base64Encoder: never
    }
    export interface Base64Decoder {
        __base64Decoder: never
    }
...
/** @noResolution */
declare module "warscript.ext.lzw" {
    export function compress(input: string): string
    export function decompress(input: string): string
}

/** @noResolution */
declare module "warscript.ext.ecc" {
    export function keypair(seed?: string): LuaMultiReturn<[privateKey: string, publicKey: string]>
    export function sign(privateKey: string, data: string): string
    export function verify(publicKey: string, signature: string, data: string): boolean
}

/** @noResolution */
declare module "warscript.ext.json" {
    export function encode(value: any): string
    export function decode(input: string): any
}

/** @noResolution */
declare module "warscript.ext.asn1" {
    export function decode(input: string): any
}
